            ...
            @foreach ($mapels as $mapel)
                <div class="d-flex justify-content-center col-lg-3 mb-4 order-0">
                    <div class="card" style="width: 20rem;">
                        <img class="card-img-top" src="{{ $mapel->gambar_url }}" alt="Card image cap"
                            style="object-fit: cover; height: 200px; width: 100%; display: block; margin-left: auto; margin-right: auto;">
                        <div class="card-body">
